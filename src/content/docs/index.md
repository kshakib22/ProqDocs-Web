...
### BOQ Domain
- [BoqSheetModel](/entities/boqsheetmodel) - BOQ sheet within a project
- [BoqEntryModel](/entities/boqentrymodel) - Individual line items within BOQ sheets
- [BoqSheetMergeModel](/entities/boqsheetmergemodel) - Excel-style merged cells for dynamic columns
...
See [log.md](/log) for documentation history.
